...
DEFAULT_TOUCH_CANDIDATE_LIMIT_PER_POOL = 10

DEFAULT_TOUCH_TOTAL_CANDIDATE_LIMIT = 24

DEFAULT_TOUCH_MAX_CORE_ENTITIES = 6

DEFAULT_TOUCH_MAX_SEARCH_TERMS = 4

DEFAULT_TOUCH_MAX_RELATED_ANGLES = 2
